        ...
        <div class="col-sm mb-3">
            <div class="card">
                <div class="card-body p-4 rounded-bottom">
                    ...
                    <nav class="my-3 mx-3">
                        <h1 class="d-flex justify-content-center"><b>To Do List</b></h1>
                    </nav>
                    ...
                    <button type="button" style="background-color: rgba(34, 138, 214, 0.4); color:black;" class="btn btn-lg btn-primary pop_button px-5 border-0"> To Do List <img src="./PicsInt/add.png" alt="Add" id="icons"></button>

                    <?php
                    foreach ($todoes as $i => $todo) : ?>
                        ...
                        <div class="card-body rounded-bottom">
                            <div class=" row sections inputbody py-3 px-5">
                                ...
                                <div class="col-4 pt-3 px-5" style="padding-right: auto;">
                                    <td>
                                        <a href='../todo/todo.update.php? id=<?php echo $todo['id'] ?>' class="btn btn-sm btn-outline-primary border-dark border-2">Edit</a>

                                        <form style="display:inline-block" method="POST" action="../todo/todo.delete.php">
                                            <input type="hidden" name='id' value="<?php echo $todo['id'] ?>">
                                            <button href='../todo/todo.delete.php?id=' <?php echo $todo['id'] ?> class="btn  btn-sm btn-outline-danger border-dark border-2">Delete</button>
                                        </form>
                                    </td>
                                </div>
