                    ...
                    <nav>
                        <div class="align-items-start">
                            <div class="nav flex-column nav-pills rounded-start" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                ...
                                <button class="nav-link my-3" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">
        ...
        <div class="col-sm mb-3">
            <div class="card">
                <div class="card-body p-4 rounded-bottom">
                    ...
                    <nav class="my-3 mx-3">
                        <h1 class="d-flex justify-content-center"><b>Class</b></h1>
                    </nav>
                    ...
                    <button type="button" style="background-color: rgba(34, 138, 214, 0.4); color:black;" class="btn btn-lg btn-primary pop_button px-5 border-0"> Courses <img src="./PicsInt/add.png" alt="Add" id="icons"></button>
                        ...
                        <div class="card-body rounded-bottom">
                            <div class=" row sections inputbody py-3">
                                ...
                                <div class="col-3 pt-3">
                                    <td>
                                        <a href='../class/class.update.php? id=<?php echo $class['id'] ?>' class="btn btn-sm btn-outline-primary border-dark border-2">Edit</a>

                                        <form style="display:inline-block" method="POST" action="../class/class.delete.php">
                                            <input type="hidden" name='id' value="<?php echo $class['id'] ?>">
                                            <button href='../class/class.delete.php?id=' <?php echo $class['id'] ?> class="btn  btn-sm btn-outline-danger border-dark border-2">Delete</button>
                                        </form>
                                    </td>
                                </div>
